...
const KForgotPWInstruction =
    "Please enter your email address below and we'll send you instructions"
    "on how to reset you password.";
const String KPopupMessageTitle = "Hmm... that's not an email address";
